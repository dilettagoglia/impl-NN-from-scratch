...
# TODO implement unittest for each function later with numpy.testing and PyTorch function
# and configure Travis for continuous integration in GitHub (if we have time and desire)
